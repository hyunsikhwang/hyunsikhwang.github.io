...
| `2` | Market Pulse KR | `https://market-pulse-kr-239485161480.us-west1.run.app/` | `monitoring` |
...
| `6` | ETF Performance | `https://etf-performance-239485161480.us-west1.run.app` | `query_stats` |
...
우측 상단의 `Private` 토글을 선택하면 Public 카드가 전환 애니메이션과 함께 사라지고, 아래 5개 private 메뉴 카드가 표시됩니다.
...
- 좌우 방향키(`ArrowLeft`, `ArrowRight`)로 Public / Private 모드를 번갈아 전환할 수 있습니다.
